...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		if arg3 == "" {
			exitGracefully(errors.New("make migration requires a name"))
		}
	...
	case "handler":
		if arg3 == "" {
			exitGracefully(errors.New("make handler requires a name"))
		}
	...
	case "model":
		if arg3 == "" {
			exitGracefully(errors.New("make model requires a name"))
		}
