...
import (
	...
	"github.com/genesysflow/celeritas/cache"
	"github.com/genesysflow/celeritas/mailer"
	"github.com/genesysflow/celeritas/render"
	"github.com/genesysflow/celeritas/session"
...
func (c *Celeritas) New(rootPath string) error {
	...
	case "mysql", "postgres", "mariadb", "postgresql", "pgsql":
...
func (c *Celeritas) creteMailer() mailer.Mail {
...
func (c *Celeritas) creteRedisPool() *redis.Pool {
	return &redis.Pool{
		MaxIdle:     50,
		MaxActive:   10000,
